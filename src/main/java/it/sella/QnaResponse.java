...
public class QnaResponse {
	...
	public static String getJsonResponse(String senderId, String requestText, UserDetail userDetail) {
		...
		case "all carte details":
			jsonResponse = "{ \"recipient\":{ \"id\":\"recipientId\" }, \"message\":{ \"attachment\":{ \"type\":\"template\", \"payload\":{ \"template_type\":\"list\", \"elements\":[ { \"title\":\"CARTE DI DEBITO\", \"image_url\":\"https://sella-bot.herokuapp.com/img/cirrus_maestro_basic.jpg\", \"subtitle\":\"CARTE\", \"buttons\":[ { \"type\":\"postback\", \"title\":\"CARTE DI DEBITO\", \"payload\":\"CARTE DI DEBITO\" } ] }, { \"title\":\"CARTE DI CREDITO\", \"image_url\":\"https://sella-bot.herokuapp.com/img/visa_classic_bse.gif\", \"subtitle\":\"VISA\", \"buttons\":[ { \"type\":\"postback\", \"title\":\"CARTE DI CREDITO\", \"payload\":\"CARTE DI CREDITO\" } ] },{ \"title\":\"CARTE DI CREDITO\", \"image_url\":\"https://sella-bot.herokuapp.com/img/mastercard_classic_bse.gif\", \"subtitle\":\"MASTER\", \"buttons\":[ { \"type\":\"postback\", \"title\":\"CARTE DI CREDITO\", \"payload\":\"CARTE DI CREDITO\" } ] }, { \"title\":\"HYPE PLUS\", \"image_url\":\"https://sella-bot.herokuapp.com/img/hype_bse.gif\", \"subtitle\":\"CARTE\", \"buttons\":[ { \"type\":\"postback\", \"title\":\"HYPE PLUS\", \"payload\":\"HYPE PLUS\" } ] } ] } } } }";
