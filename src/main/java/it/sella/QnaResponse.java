	...
	public static String getJsonResponse(String senderId, String requestText, UserDetail userDetail) {
		...
		case "hi":
			jsonResponse = String.format(
					...
					"Ciao " + userDetail.getFirstName() + " " + userDetail.getLastName()+",How can I help you?"+ "Abbiamo a disposizione carte di credito, carte di debito e prepagate. \"Dalla\" sezione carte seleziona la voce Cercalacartachefaperte e ti aiuteremo a cercare quella più adatta alle tue esigenze. Clicca qui per accedere alla pagina.".replaceAll("\\\"", "\\\\\""));
			break;		
		case "view product":
